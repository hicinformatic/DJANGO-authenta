...
class Method(models.Model):
    ...
    groups = models.ManyToManyField(Group, verbose_name=_('Groups associated'))
    permissions = models.ManyToManyField(Permission, verbose_name=_('Permissions associated'))
    ...
    ht_ldapuser = _('Replace Bind DN by a User DN. <strong>Do not use with Bind DN</strong> | user DN ex : uid={{tag}},ou=my-ou,dc=domain,dc=com | Available tags: username,email')
