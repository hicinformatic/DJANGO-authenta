...
logmethis(7, 'binary_extension: %s' % str(AuthentaConfig.binary_ext))
logmethis(7, 'python_os: %s' % str(AuthentaConfig.python))
logmethis(7, 'python_extension: %s' % str(AuthentaConfig.python_ext))
logmethis(7, 'python_backstart: %s' % str(AuthentaConfig.python_start))
logmethis(7, 'ptyhon_end_option: %s' % str(AuthentaConfig.python_end))
